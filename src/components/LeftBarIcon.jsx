...
export function SmallBarIcon ({icon, title, smallMenu, menuClicked, iconSelected, setIconSelected}) {
...
export function LargeBarIcon ({icon, title, menuClicked, divider, iconSelected, setIconSelected}) {
    return(
